...
The script keeps the raw Excel files untouched and creates model-ready CSV files:
  ...
  data_preprocessing/ahu_clean_5min.csv
  data_preprocessing/ahu_clean_5min_running.csv
  data_preprocessing/ahu_model_5min.csv
  data_preprocessing/preprocess_report_5min.txt
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default="data_preprocessing/preprocess", help="Directory for processed CSV files.")
